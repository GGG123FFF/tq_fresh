...
function CommanderVault() {
  ...
  var _useStateSort = useState(_tqSortInit),
    _useStateSortArr = _slicedToArray(_useStateSort, 2),
    sortMode = _useStateSortArr[0],
    setSortModeRaw = _useStateSortArr[1];
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    /*#__PURE__*/React.createElement("option", { value: "manual" }, "Manual order"),
    /*#__PURE__*/React.createElement("option", { value: "alpha" }, "A → Z"),
    /*#__PURE__*/React.createElement("option", { value: "identity" }, "By colour identity")
  )), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
...
function VaultDeckCard(_ref21) {
  ...
  }, deck.theme))), /*#__PURE__*/React.createElement("div", {
...
function TokenTracker() {
  ...
  React.createElement(PetPanel, {
    ...
    style: { display: "flex", alignItems: "center", gap: 6, marginTop: 4, marginBottom: 4, fontSize: 9, color: "#8a7555", fontFamily: "'Cinzel', serif", letterSpacing: "0.15em" }
  },
    ...
    ['easy', 'normal', 'hard', 'expert'].map(function (tier) {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        style: {
          ...
          border: "1px solid " + (active ? "#c9a961" : "rgba(154,135,101,0.3)"),
          color: active ? "#f5d98f" : "#9a8765",
          borderRadius: "2px",
          fontFamily: "inherit",
          fontSize: "inherit",
          cursor: "pointer",
